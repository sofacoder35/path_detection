...
//{
    ...
    public:
        ...
        std::pair<iterator, iterator>          get_random_scc_neighbors_iterators();
        ...
        void                                   add_scc_node(on_the_fly_scc_graph_node<union_node>*);

    public:
        std::vector<on_the_fly_scc_graph_node<union_node>*> _neighbors;
        long                                              _label;
        std::vector<on_the_fly_scc_graph_node<union_node>*> _scc_nodes;
        std::vector<on_the_fly_scc_graph_node<union_node>*> _neighbor_representative_nodes;

...
template<typename union_node>
std::pair<typename on_the_fly_scc_graph_node<union_node>::iterator, typename on_the_fly_scc_graph_node<union_node>::iterator>
on_the_fly_scc_graph_node<union_node>::get_random_scc_neighbors_iterators() {
    return {iterator(_neighbor_representative_nodes, 0), iterator(_neighbor_representative_nodes, _neighbor_representative_nodes.size())};
}
...
template <typename union_node>
void
on_the_fly_scc_graph_node<union_node>::add_scc_node(on_the_fly_scc_graph_node<union_node> * node)
{
    _scc_nodes.push_back(node);
}
